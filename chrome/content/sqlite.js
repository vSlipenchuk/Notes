/*
    ...
    Хочется переписать. А чем не нравится текущая? Живи с ней...

    Нужно прикрутить - связанные переменные... Да блин - много чего еще.
    Обработку ошибок нормальнуююю...
*/
