...
//this.loaded = 1; // ok
//alert('db done ok, call refresh');
this.refresh();
//alert('refresh done...');

},
 Refresh: function () { // Mk a refresh with a database...
  alert('Total Refresh of selected!'); 
...
vTree.prototype.setFun = function (el) {
//alert('setFun called,, el='+el);  
}

vTree.prototype.setData = function (data,el) {
//alert('SetData with el='+el+' and data='+data);
...
var ex;
  try {
    //this.ctrl.view=undef;
    //this.ctrl.view = this; // reset view?
   //this.boxObject.invalidateRange(0,1000);  
   this.boxObject.rowCountChanged(0,this._getRowCount(this.data)); // Redraw all...this.boxObject.rowCountChanged(0,10000); // Redraw all...
  } catch(ex) {};
}
